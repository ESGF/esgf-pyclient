...
A convenience function is supplied for specifying :func:`all_of`.  E.g. you could specify a search accross 2 experiments for datasets containing both variables 'tas' and 'pr'::
